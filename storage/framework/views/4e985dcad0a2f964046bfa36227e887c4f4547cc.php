...
<head>
    ...
    <style>
        .a4 {
            ...
            padding: 20px;
            margin: auto;
            /*background-image: url("<?php echo e(asset('assets/login-bg.jpg')); ?>"); */
            background: white;
    ...
    <div class="card w-100">
      ...
      <div class="a4" id="printableCardBody">
       ...
       <div class="col-md-6 col-sm-6 d-flex align-items-center">
                <img src="<?php echo e(asset('assets/img/avatar/logo.png')); ?>" alt="E-Abyana Logo" class="mr-3" style="width: 80px;"> <!-- Logo -->
                <div>
        ...
        <div class="col-md-8 col-sm-8" style="border:1px solid gray;">
          <div class="row">
            <div class="col-md-4 col-sm-4">
              ...
              <p>1000000000<?php echo e($relatedData->id); ?></p>
            ...
            <div class="col-md-4 col-sm-4">
              ...
              <p><?php echo e($relatedData->divsion_name); ?></p>
              <span><strong>District</strong></span>
              <p><?php echo e($relatedData->name); ?></p>
            </div>

            <div class="col-md-4 col-sm-4">
              <span><strong>Tehsil</strong></span>
              <p><?php echo e($relatedData->tehsil_name); ?></p>
              <span><strong>Halqa</strong></span>
              <p><?php echo e($relatedData->halqa_name); ?></p>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/E-Abyana-Collection-System/resources/views/LandRecord/viewBill.blade.php ENDPATH**/ ?>