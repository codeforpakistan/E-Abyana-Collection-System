            ...
            <section class="section">
                ...
                <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12" style="margin-top: 80px;">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="<?php echo e(route('update.irrigator', $irrigator->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?> <!-- This ensures the form submits as a PUT request -->
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <select name="village_id" id="village_id" class="form-control" required>
                                            ...
                                            <?php $__currentLoopData = $villages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $village): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($village->village_id); ?>" <?php echo e(old('village_id', $irrigator->village_id) == $village->village_id ? 'selected' : ''); ?>>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input class="form-control form-control-lg" type="text" id="irrigator_name" name="irrigator_name"
                                            value="<?php echo e(old('irrigator_name', $irrigator->irrigator_name)); ?>" required>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input class="form-control form-control-lg" type="text" id="irrigator_khata_number" name="irrigator_khata_number"
                                            value="<?php echo e(old('irrigator_khata_number', $irrigator->irrigator_khata_number)); ?>" required>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input class="form-control form-control-lg" type="text" id="irrigator_mobile_number" name="irrigator_mobile_number"
                                            value="<?php echo e(old('irrigator_mobile_number', $irrigator->irrigator_mobile_number)); ?>" required>
                                    </div>
                                </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/E-Abyana-Collection-System/resources/views/edit-irrigator.blade.php ENDPATH**/ ?>