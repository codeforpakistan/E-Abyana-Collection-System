                            ...
                            <form class="form-horizontal" action="{{ route('updateCanal', $canal->id) }}" method="POST">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select name="village_id" id="village_id" class="form-control" required>
                                            ...
                                            @foreach($villages as $village)
                                                <option value="{{ $village->village_id }}" {{ $village->village_id == $canal->village_id ? 'selected' : '' }}>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input class="form-control form-control-lg" type="text" name="canal_name" value="{{ $canal->canal_name }}" required>
                                    </div>
                            
                                    <div class="form-group col-lg-6">
                                        <label class="form-label font-weight-bold">No. of Outlets</label>
                                        <input class="form-control form-control-lg" type="text" name="no_outlet" value="{{ $canal->no_outlet }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input class="form-control form-control-lg" type="text" name="no_outlet_ls" value="{{ $canal->no_outlet_ls }}" required>
                                    </div>
                            
                                    <div class="form-group col-lg-6">
                                        <label class="form-label font-weight-bold">No. of Outlets (Right Side)</label>
                                        <input class="form-control form-control-lg" type="text" name="no_outlet_rs" value="{{ $canal->no_outlet_rs }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input class="form-control form-control-lg" type="text" name="total_no_cca" value="{{ $canal->total_no_cca }}" required>
                                    </div>
                            
                                    <div class="form-group col-lg-6">
                                        <label class="form-label font-weight-bold">Total No. of Discharge (Cusec)</label>
                                        <input class="form-control form-control-lg" type="text" name="total_no_discharge_cusic" value="{{ $canal->total_no_discharge_cusic }}" required>
                                    </div>
                                </div>
